 ...
 * @version 	0.9
 * 
 * @description	adapted from AbstractExample from
 * 				https://code.google.com/p/odata4j/source/browse/odata4j-examples/src/main/java/org/odata4j/examples/AbstractExample.java?r=7d3940f46db3b79f70b5eeb378f021cf986d95d2
 *
 */
public abstract class EntityReporting {
  ...
  protected static void reportEntity(String caption, OEntity entity) {
    report(caption);
    /* TODO CHECK FOR IMPORT FAILURES
