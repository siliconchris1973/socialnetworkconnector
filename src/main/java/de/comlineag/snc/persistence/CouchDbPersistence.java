 ...
 *
 * @description handles the connectivity to a CouchDb and saves and updates posts and users in the DB
 * 
...
public class CouchDbPersistence implements IPersistenceManager {
	...
	public CouchDbPersistence() {
		//@SuppressWarnings("unused")
		//final CouchDbConfiguration couchDbConfig = new CouchDbConfiguration();
	}
