...
public class SimpleWebCrawler2  implements Job {
 ...
 public void execute(JobExecutionContext arg0) { 
	String urlToParse = (String) arg0.getJobDetail().getJobDataMap().get("server_url");
	 
	 initialize(urlToParse, 20);
...
public void initialize(String urltoparse, int maxd) {
 URL url;
 knownURLs = new Hashtable();
 newURLs = new Vector();
 try { url = new URL(urltoparse); }
   catch (MalformedURLException e) {
     System.out.println("Invalid starting URL " + urltoparse);
     return;
   }
