 ...
 */
    ...
    public static List<String> getStringListFromJsonArray(JSONArray jArray) throws Exception {
      List<String> returnList = new ArrayList<String>();
      for (int i = 0; i < jArray.size(); i++) {
        String val = jArray.get(i).toString();
        returnList.add(val);
      }
      return returnList;
    }
 */
    ...
    public static List<Object> getListFromJsonArray(JSONArray jArray) throws Exception {
 ...
 */
  ...
  public static List<Object> getListFromJsonObject(JSONObject jObject) throws Exception {
      List<Object> returnList = new ArrayList<Object>();
      Iterator<String> keys = jObject.keySet();
 ...
 */
    ...
    public static Object convertJsonItem(Object o) throws Exception {
      if (o == null) {
        return "null";
      }
...
*/
    ...
    /*
    public static String getJsonRepresentation(Object value) throws Exception {
...
*/
    ...
    /*
    public static Object getObjectFromJson(String jsonString) throws Exception {
